...
import me.phoenixra.atumodcore.api.gui.menus.scroll.ScrollArea;
import me.phoenixra.atumodcore.api.gui.menus.scroll.ScrollAreaEntry;
...
public class FilePickerPopup extends Popup {
    ...
    private static ResourceLocation fileIcon = new ResourceLocation("atum", "filechooser/file_icon.png");
    private static ResourceLocation folderIcon = new ResourceLocation("atum", "filechooser/folder_icon.png");
    private static ResourceLocation backIcon = new ResourceLocation("atum", "filechooser/back_icon.png");
    ...
    private GuiElementButton chooseButton;
    ...
    public FilePickerPopup(String directory, @Nullable String home, @Nullable Popup fallback, boolean checkForLastPath, Consumer<File> callback, @Nullable String... filetypes) {
        ...
        this.chooseButton = new GuiElementButton(0, 0, 100, 20, "Choose", true, (press) -> {
        ...
        this.closeButton = new GuiElementButton(0, 0, 100, 20, "Cancel", true, (press) -> {
    ...
    public void render(int mouseX, int mouseY, GuiScreen renderIn) {
        ...
        drawCenteredString(Minecraft.getMinecraft().fontRenderer, "§lChoose File", renderIn.width / 2, 17, Color.WHITE.getRGB());

        if (this.filetypesString != null) {
            drawCenteredString(Minecraft.getMinecraft().fontRenderer, "Supported file types: " + this.filetypesString, renderIn.width / 2, renderIn.height - 50, Color.WHITE.getRGB());
    ...
    public void updateFileList() {
        ...
        for (File f : this.directory.listFiles()) {
            if (f.isDirectory() || this.filetypes.isEmpty()) {
    ...
    public void onEnterPressed(KeyboardData d) {
        if ((d.keycode == 257) && this.isDisplayed() && focused != null) {
            this.focused.onClick();
        }
    }
    ...
    public static class FileChooserEntry extends ScrollAreaEntry {
        ...
        public void renderEntry() {
            ...
            if (this.type == Type.BACK) {
                Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("BACK", this.x + 30, this.y + 7, Color.WHITE.getRGB());
            } else {
