...
import me.phoenixra.atumodcore.misc.AtumColor;
import me.phoenixra.atumodcore.misc.animation.AnimationRenderer;
...
public class SimpleLoadingScreen extends GuiScreen {
    ...
    private LoadingAnimationRenderer loading = new LoadingAnimationRenderer("atum/animations/loading", 15, true, 0, 0, 16, 16, "atum", null);
    ...
    private static class LoadingAnimationRenderer extends AnimationRenderer {
        ...
        protected void renderFrame() {
            ...
            if (this.isStretchedToScreenSize()) {
            ...
            float[] colorf = AtumColor.fromHex(this.hex).toColor().getComponents(new float[4]);
            if (colorf != null) {
