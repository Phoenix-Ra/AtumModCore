...
public class AtumFolderResourcePack extends FolderResourcePack {
    public AtumFolderResourcePack() {
    ...
    public <T extends IMetadataSection> T getPackMetadata(@NotNull MetadataSerializer metadataSerializer,
        ...
        return (T)readMetadata(metadataSerializer, Minecraft.getMinecraft().getResourceManager()
                .getResource(PackHandler.DUMMY_PACK_META).getInputStream(), metadataSectionName);
    }
    ...
    //To change the assets dir from packRoot/assets to packRoot/
    @Override
    public InputStream getInputStream(@NotNull ResourceLocation location) throws IOException {
