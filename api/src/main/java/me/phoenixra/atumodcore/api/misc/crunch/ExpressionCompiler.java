...
import me.phoenixra.atumodcore.api.misc.crunch.data.CharTree;
import me.phoenixra.atumodcore.api.misc.crunch.data.FastNumberParsing;
import me.phoenixra.atumodcore.api.misc.crunch.data.TokenList;
import me.phoenixra.atumodcore.api.misc.crunch.exceptions.ExpressionCompilationException;
import me.phoenixra.atumodcore.api.misc.crunch.functional.ArgumentList;
...
import me.phoenixra.atumodcore.api.misc.crunch.functional.FunctionCall;
import me.phoenixra.atumodcore.api.misc.crunch.token.*;
import me.phoenixra.atumodcore.api.misc.crunch.token.*;
...
class ExpressionCompiler {
	...
	private static class OperatorList extends ArrayList<TokenList.Node> {}
	
	private static Value reduceTokens(TokenList tokens) {
		OperatorList[] priorities = new OperatorList[11];
		for (TokenList.Node node = tokens.head(); node != null; node = node.next) {
